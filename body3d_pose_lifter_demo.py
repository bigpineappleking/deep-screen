...
def process_one_image(args, detector, frame, frame_idx, pose_estimator,
    ...
    for idx, pose_lift_result in enumerate(pose_lift_results):
        ...
        # print(pred_instances.keypoints.shape)
...
def main():
    ...
    if input_type == 'image':
        ...
        while video.isOpened():
            ...
            # print(pose_est_results_list[frame_idx-1][0].pred_instances)
            if args.save_predictions:
                # save prediction results
                pred_instances_list.append(
                    dict(
                        ...
                        instances=split_instances(pose_est_results_list[frame_idx-1][0].pred_instances)))
    ...
    ## edit here is more information is needed for analysis
    video_info=[] 
    video_info.append(
        dict(
